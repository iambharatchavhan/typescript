...
let emptyArray = []; // like this we can push any type in it
//! Tupels
/**
...
let tupelArray = [true, 21, "tupel-array"];
...
const greetActors2 = (actorobject) => {
    // checking first if name of actors are present or not
    return `hello Mr/Mrs: ${actorobject === null || actorobject === void 0 ? void 0 : actorobject.name} welcome to the function`;
};
...
var Grades2;
(function (Grades2) {
    Grades2[Grades2["U"] = 1] = "U";
    Grades2[Grades2["D"] = 2] = "D";
    Grades2[Grades2["C"] = 3] = "C";
    Grades2[Grades2["E"] = 4] = "E";
